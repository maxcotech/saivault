...
class HiddenFileModel{
  String hiddenPath,originalPath,initialVector,createdAt;
  int id,hidden;

  HiddenFileModel({this.hiddenPath,this.originalPath,this.initialVector,this.createdAt,this.hidden,this.id});
